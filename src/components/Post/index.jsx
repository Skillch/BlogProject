    ...
    if (isFormPage) {
        return <>
            <form className="editForm">
                ...
                <button className="edt" type="submit" value="Submit" onClick={onClickEdit}>Применить</button>
                <button className="edt" type="submit" value="Submit" onClick={onClickCancel}>Отмена</button>
            </form>
        </>
    } else {
        return (
